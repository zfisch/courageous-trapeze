...
```
git remote add upstream https://github.com/courageous-trapeze/<NAME_OF_REPO>.git
```
...
1. Your pull request is comprised of a single ([squashed](http://kevhuang.com/cleaning-up-your-git-commit-history/)) commit.
